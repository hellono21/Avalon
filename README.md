...
这是一个渐进式 Web 应用 (PWA),旨在替代传统的卡牌分发和法官(上帝)流程。通过一部手机即可组织 **4-10 人**的完整游戏,支持全流程引导、身份分配、投票记录及逻辑判定。
...
*   **🎮 多种游戏模式**:
    *   **标准版 (5-10人)**: 支持完整的角色配置和刺杀环节。
    *   **4人简化版**: 固定配置(3忠臣+1爪牙),3轮任务,2胜即赢,无刺杀环节,适合快速游戏。
*   **🎭 灵活的角色配置**:
    *   标准版支持 5-10 人局的自定义配置。
...
当玩家人数为4时,自动启用简化规则,适合快速游戏:

1.  **固定角色**: 3个忠臣 + 1个爪牙(无特殊角色)
2.  **任务流程**: 3轮任务,每轮2人执行
3.  **胜利条件**: 2个任务成功即好人胜利,2个任务失败即坏人胜利
4.  **无刺杀环节**: 游戏结束直接判定胜负
